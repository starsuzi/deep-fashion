...
df_attr_category_combined = pd.read_csv('./csv/df_category_attr_combined_from_imgfile.csv')
...
#save
file_name = "merged_by_img_attributes.csv"
df_final.to_csv("./csv/"+file_name, index=None)